...
-- Find nearest city which is Singapore
SELECT *
FROM city_list
WHERE city LIKE 'Singapore';

-- Extract both Singapore and global data by joining the 2 tables and create new columns for the respective average temperature.
...
-- There were missing average temperature data for Singapore from year 1825 to 1838 thus they were removed for this analysis.
